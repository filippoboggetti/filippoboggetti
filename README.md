...
- **LATAM Airlines: valuation model** — group project, Corporate Finance, Bocconi MSc, autumn 2022. DCF model of LATAM Airlines Group after Chapter 11 (revenue drivers by market, ASK/RPK traffic, jet-fuel and Brazil-GDP regressions, pro-forma statements, CAPEX and debt schedule), with the revenue-forecasting and cargo workbooks and an industry note. Underlying data from LATAM's investor-relations disclosures; the workbooks keep dangling links to the original IR sources, so Excel may ask about updating links. [DCF model (Excel)](https://github.com/filippoboggetti/filippoboggetti/raw/main/assets/Boggetti_2022_LATAM_DCF_model.xlsx) · [Revenue forecasting (Excel)](https://github.com/filippoboggetti/filippoboggetti/raw/main/assets/Boggetti_2022_LATAM_revenue_forecasting.xlsx) · [Cargo (Excel)](https://github.com/filippoboggetti/filippoboggetti/raw/main/assets/Boggetti_2022_LATAM_cargo.xlsx) · [Industry note (PDF)](https://cdn.jsdelivr.net/gh/filippoboggetti/filippoboggetti@main/assets/Boggetti_2022_Air_transport_in_time_of_turbulence_LATAM_note.pdf)
