...
- **LATAM Airlines: valuation model** — group project, Corporate Finance, Bocconi MSc, autumn 2022. DCF model of LATAM Airlines Group after Chapter 11: revenue drivers by market, ASK/RPK traffic, jet-fuel and Brazil-GDP regressions, pro-forma statements, CAPEX and debt schedule. Underlying data from LATAM's investor-relations disclosures; the workbook keeps dangling links to the original IR sources, so Excel may ask about updating links. [DCF model (Excel)](https://github.com/filippoboggetti/filippoboggetti/raw/main/assets/Boggetti_2022_LATAM_DCF_model.xlsx)
